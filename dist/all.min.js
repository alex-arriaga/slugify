!function(){var e=function(){function e(e){e=e.replace(/^\s+|\s+$/g,""),e=e.toLowerCase();for(var a="àáäâèéëêìíïîòóöôùúüûñç·/_,:;",r="aaaaeeeeiiiioooouuuunc------",n=0,o=a.length;n<o;n++)e=e.replace(new RegExp(a.charAt(n),"g"),r.charAt(n));return e=e.replace(/[^a-z0-9 -]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")}return{createSlug:e}}();void 0===window.Slugify&&(window.Slugify=e)}();
